...
var LOGIN = {
    ...
    UIElements: {
        $login_username: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.login-input-user'),
        $login_password: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.login-input-pass'),
        $button_send_login: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.button-send-login'),
        $content_to_change: __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#content-to-change'),
...
var DASHBOARD = {
    ...
    viewBilling: function viewBilling() {
        var data = {
            _token: this.UIElements.$csrf_token
        };
